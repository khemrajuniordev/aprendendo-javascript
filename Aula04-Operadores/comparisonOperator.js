...
console.log("Bia tem idade igual a de Matheus? ", idadeBia === idadeMatheus);
console.log("Bia tem a idade diferente da de Matheus? ", idadeBia !== idadeMatheus);
...
console.log("O número " + x + " é diferente do número " + y, x !== y); // !== operador de Diferença Estrita
console.log("O número " + x + " é diferente do número " + z, x != z); // != operador de Diferença Frouxa